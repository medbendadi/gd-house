...
export const components: Components<Theme> = {
  ...
  MuiDialog: {
    styleOverrides: {
      paper: { borderRadius: 12, boxShadow: "none" }
    }
  },
  MuiCard: {
  ...
  MuiButton: {
    variants: [
      ...
      {
        props: { color: "orange" },
        style: { color: "white", backgroundColor: orange.main }
      },
      {
        props: { color: "success" },
        style: { color: "white", backgroundColor: success.main }
      }
    ],
  ...
  MuiPopover: {
    ...
    styleOverrides: { paper: { borderRadius: 8, marginTop: 4 } }
  },
  MuiSlider: {
    styleOverrides: {
