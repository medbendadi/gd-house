...
export const categoryNavigation = [
  {
    ...
    categoryItem: [
      ...
      { icon: "Popular", title: "Popular Products", href: "/gift-shop/popular" },
      { icon: "Trending", title: "Trending Products", href: "/gift-shop/trending" },
  ...
  },
  {
    ...
    categoryItem: [
      ...
      { icon: "TeddyBear", title: "Teddy Bears", href: "/gift-shop/teddy-bears" },
      { icon: "ValentineGift", title: "Valentine Gifts", href: "/gift-shop/valentine-gifts" },
      { icon: "WeddingGift", title: "Wedding Gifts", href: "/gift-shop/wedding-gifts" },
      { icon: "NewYearGift", title: "New Year Gift", href: "/gift-shop/new-year-gift" },
