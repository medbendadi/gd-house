...
export const featuredcategories = [
  { id: 1, name: "Computer", icon: "LaptopLight", totalProduct: 8 },
  { id: 2, name: "Controller", icon: "Microchip", totalProduct: 6 },
  { id: 3, name: "Hardware", icon: "Gear", totalProduct: 7 },
  { id: 4, name: "Home Smart", icon: "HouseSignal", totalProduct: 10 },
  { id: 5, name: "Monitor", icon: "Desktop", totalProduct: 16 },
  { id: 6, name: "Smartphone", icon: "MobileNotch", totalProduct: 21 },
  { id: 7, name: "Tablet", icon: "Tablet", totalProduct: 9 },
  { id: 8, name: "Smart Watch", icon: "WatchApple", totalProduct: 15 }
];
