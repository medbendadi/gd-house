...
export const categoryNavigation = [
  {
    ...
    categoryItem: [
      ...
      { icon: "Popular", title: "Popular Products", href: "/furniture-1/popular" },
      { icon: "Trending", title: "Trending Products", href: "/furniture-1/trending" }
    ]
  },
  {
    category: "Top Categories",
    categoryItem: [
      ...
      { icon: "RoundTable", title: "Coffee Tea Table", href: "/furniture-1/coffee-tea" },
      { icon: "RoomSet", title: "Living Room Sets", href: "/furniture-1/living-room" }
    ]
  }
];
